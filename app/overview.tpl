...
<div class="row">
  <div class="col-sm-12">
    <h1>Product Design Style Guide</h1>
    <p>This is the product style guide and is a living document. It will update often as designs evolve and improve. The purpose of this guide follows:</p>
    <ul>
      <li>Explain pattern usage, foundational elements and live code examples</li>
      <li>Provide a unified visual and interaction experience to be utilized by Paradata developers</li>
      <li>Provide common UI components to preserve consistency and improve speed of development</li>
    </ul>
  </div>
</div>
<div class="col-sm-4">
